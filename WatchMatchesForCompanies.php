...
<form name="HEADING" style="text-align:center">
	<h3>Please Enter Email and Password For Your Company  </h3>
</form>

<form action="WatchMatchesForCompaniesConfirm.php" method="POST" >
                <table align="center">   
                ...
                <center>
                    <input type="submit" value="See Available Lancers for Company " /> </br>  
