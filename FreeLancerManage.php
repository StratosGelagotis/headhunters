...
<form name="HEADING" style="text-align:center">
	<h3>Fill the form to publish your availability  </h3>
</form>
 
<form action="FreeLancerManageConfirm.php" method="POST" >
                <table align="center">   
                <tr><td align="left">*Email:</td><td><input type="email" value="Used as Username" name="Email" align="center" required/></td></tr>    
		      ...
		      <tr><td align="left">*Diploma:</td><td><input type="text" name="Diploma" align="center" required /></td></tr> 
		      <tr><td align="left">*Foreign Languages:</td><td><input type="text" name="ForeignLanguages" align="center" required/></td></tr> 
		      <tr><td align="left">*Working Town:</td><td><input type="text" name="WorkingTown" align="center" required /></td></tr> 
		      <tr><td align="left">*Solary(€):</td><td><input type="number" name="Solary" align="center" required/></td></tr> 
		      <tr><td align="left">*Working Scedule(hours):</td><td><input type="number" name="WorkingScedule" align="center" required /></td></tr><tr><td align="left">
			 ...
			 <TD ALIGN="center"></TD>
                		...
                		<center>
                        <input type="submit" value="Publish Job Availability(Cost:10€)"  />    </br>  
