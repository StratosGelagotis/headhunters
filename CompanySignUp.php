...
<form action="CompanySignUpConfirm.php" method="POST" >
                <table align="center">   
                   <tr><td align="left">*Company Name:</td><td><input type="text" name="Name" align="center" required  /></td> </tr> 
                   ...
                   <tr><td align="left">*AccountBalance:</td><td><input type="text" name="AccountBalance" align="center" required/></td></tr>
                		...
                		<center>
                        <input type="submit" value="Company Registration(Cost:50€)"  /> </br>  
